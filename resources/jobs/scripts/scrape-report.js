...
function sanitizeReport(report = {}) {
  return {
    ...
    parser_selectors_used: Array.isArray(report.parser_selectors_used) ? report.parser_selectors_used : [],
    ...
    source_temporarily_unavailable: Boolean(report.source_temporarily_unavailable),
    fallback_used: Boolean(report.fallback_used),
    fallback_reason: String(report.fallback_reason || "").trim(),
